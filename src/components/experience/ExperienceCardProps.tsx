  ...
  return (
    ...
    >
      ...
      <div className="absolute left-0 top-0 bottom-0 w-[2px] bg-slate-800/50 group-last:bg-transparent">
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-4 h-4 rounded-full bg-[#0F172A] border-2 border-red-500 z-10 shadow-[0_0_8px_rgba(59,130,246,0.5)] group-hover:bg-red-500 transition-colors duration-300"></div>
      </div>

      <div className="glass-panel rounded-2xl p-6 border border-white/5 shadow-lg group-hover:border-red-500/30 group-hover:shadow-[0_0_20px_rgba(59,130,246,0.1)] transition-all duration-300 relative overflow-hidden">
        {highlighted && (
        ...
        <header className="flex justify-between items-start mb-4 flex-wrap gap-2 relative z-10">
          ...
          {highlighted && (
            <span className="px-3 py-1 rounded-full bg-red-500/10 text-red-400 text-[10px] font-bold uppercase tracking-wider border border-red-500/20 shadow-[0_0_10px_rgba(59,130,246,0.2)]">
              Current
            </span>
          )}
        </header>
